...
public class SpriteManager : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (WorldManager.instance.HoveredDraggable != null && WorldManager.instance.HoveredDraggable.CanBeDragged() && WorldManager.instance.CanInteract)
		{
			bool flag = true;
		...
		{
			if (WorldManager.instance.HoveredDraggable != null && WorldManager.instance.HoveredDraggable is CardConnector)
			{
				this.SetCursorFast(this.CursorCanDrag, new Vector2(166f, 165f) * num, CursorMode.Auto);
				return;
			}
