...
- [ ] **Sinh qu�i ng?u nhi�n (Random Enemy Generation)**: Chua ho�n th�nh. H? th?ng DogEnemyGenerator hi?n t?i dang d�ng logic placeholder d? sinh qu�i, c?n pool sinh ng?u nhi�n chi ti?t theo biome.
- [ ] **Spawn Node Combat / Spawn Card Enemy Board**: V?n chua ho�n thi?n logic v?t l� khi spawn node combat v� th? enemy ra ngo�i board ch�nh.
